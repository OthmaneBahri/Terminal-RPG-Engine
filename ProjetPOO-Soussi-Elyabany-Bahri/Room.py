...
class Room(object):
    ...
    def randCoordNoCoin(self):
        """A random coordinate inside the room and not the coin"""
        return Coord(random.randint(self.c1.x + Coord(1,1),self.c2.x + Coord(-1,-1)), random.randint(self.c1.y, self.c2.y))
